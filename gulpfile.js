...
gulp.task('process-app-js', () => {
	...
	appFolders.forEach((folder) => {
		gulp.src([`js/apps/${folder}/app.js`, `js/apps/${folder}/constants.js`, `js/apps/${folder}/filters/**/*.js`, `js/apps/${folder}/dataServices/**/*.js`, `js/apps/${folder}/services/**/*.js`, `js/apps/${folder}/controllers/**/*.js`, `js/apps/${folder}/directives/**/*.js`])
			.pipe(jshint({
				esversion: 6
			}))
