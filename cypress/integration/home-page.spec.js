...
describe('BCPL Home Page', () => {
    ...
    describe('Recommended Titles', () => {
        ...
        it('should navigate you to the recommended title page when selecting the view recommended titles button', () => {
            cy
                .get('a[href="https://catalog.bcpl.lib.md.us/polaris/search/searchresults.aspx?ctx=1.1033.0.0.5&type=Boolean&term=brs=110016&by=KW&sort=RELEVANCE&limit=&query=&page=0&_ga=2.147464055.1957335811.1525693477-387282619.1513796176"]')
                .should('exist');
